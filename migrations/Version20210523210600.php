 ...
 */
final class Version20210523210600 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatar VARCHAR(127) CHARACTER SET utf8mb4 DEFAULT \'default.png\' NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP avatar_id');
    }
}
